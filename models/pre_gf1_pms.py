...
'''
@Author: cuiqiyuan
@Description: 高分1号PMS传感器数据(8m)预处理
...
# 辐射定标系数表
SCALES = {
    'PMS1_2015': [0.211, 0.1802, 0.1806, 0.187],
    'PMS2_2015': [0.2242, 0.1887, 0.1882, 0.1963],
    'PMS1_2016': [0.232, 0.187, 0.1795, 0.196],
    'PMS2_2016': [0.224, 0.1851, 0.1793, 0.1863],
    'PMS1_2017': [0.1424, 0.1177, 0.1194, 0.1135],
    'PMS2_2017': [0.1460, 0.1248, 0.1274, 0.1255],
    'PMS1_2018': [0.1530, 0.1356, 0.1366, 0.1272],
    'PMS2_2018': [0.1523, 0.1382, 0.1403, 0.1334],
    'PMS1_latest': [0.1530, 0.1356, 0.1366, 0.1272],
    'PMS2_latest': [0.1523, 0.1382, 0.1403, 0.1334]
}
...
def main(ifile, shp_file=None, cut_range=None, aerotype=1,
    ...
    if date_str[0:4] == '2015' and 'PMS1' in path_name:
        scales = SCALES['PMS1_2015']
    elif date_str[0:4] == '2015' and 'PMS2' in path_name:
        scales = SCALES['PMS2_2015']
    elif date_str[0:4] == '2016' and 'PMS1' in path_name:
        scales = SCALES['PMS1_2016']
    elif date_str[0:4] == '2016' and 'PMS2' in path_name:
        scales = SCALES['PMS2_2016']
    elif date_str[0:4] == '2017' and 'PMS1' in path_name:
        scales = SCALES['PMS1_2017']
    elif date_str[0:4] == '2017' and 'PMS2' in path_name:
        scales = SCALES['PMS2_2017']
    elif date_str[0:4] == '2018' and 'PMS1' in path_name:
        scales = SCALES['PMS1_2018']
    elif date_str[0:4] == '2018' and 'PMS2' in path_name:
        scales = SCALES['PMS2_2018']
    elif 'PMS1' in path_name:
        scales = SCALES['PMS1_latest']
    elif 'PMS2' in path_name:
        scales = SCALES['PMS2_latest']
    else:
        print('无法识别的传感器类型!')
        return(0)
    month = date_str[4:6]
    ...
    name_out = '%s_%s_8_L2_%s_%s_%s.tiff' % (satellite_code, sensor_code, date_str, nrow, ncolm)
